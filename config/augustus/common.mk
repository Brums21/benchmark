...
INCLUDE_PATH_SUITESPARSE := -I/${BENCHMARK_DIR}/libs/suitesparse/include
LIBRARY_PATH_SUITESPARSE := -L/${BENCHMARK_DIR}/libs/suitesparse/lib -Wl,-rpath,${BENCHMARK_DIR}/libs/suitesparse/lib
...
LIBRARY_PATH_SQLITE      := -L/${BENCHMARK_DIR}/libs/libsqlite3-dev/usr/lib/x86_64-linux-gnu -Wl,-rpath,${BENCHMARK_DIR}/libs/libsqlite3-dev/usr/lib/x86_64-linux-gnu
